...
function clickOn(ax,by)
{
    if(clickChoice == 1)         //1为配送
    {
        //点击动画
            ...
            appearP.src="../static/NR-XLSPT-master/icon RE/deliver_fill2.png";
    ...
    if(clickChoice == 2)         //2为门店
    {
        ...
        appearS.src="../static/NR-XLSPT-master/icon RE/shopfill.png";
    ...
    if(clickChoice == 3)         //3为顾客
    {
        ...
        appearC.src="../static/NR-XLSPT-master/icon RE/home_fill_light.png";
...
{   document.getElementById("pathline").style.zIndex="1";
    ...
    {   context.beginPath();
        ...
        context.moveTo(pathSheet[canvi][0].x-(document.body.clientWidth)+605,pathSheet[canvi][0].y-125);
        for(var canin = 0;canin<capacity+1;canin++)
        {
            context.lineTo(pathSheet[canvi][canin+1][0].x-(document.body.clientWidth)+605,pathSheet[canvi][canin+1][0].y-125);
        }
